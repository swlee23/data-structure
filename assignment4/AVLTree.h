...
public:
    ...
    bool remove(keyT key) {
        ...
        // There can be several ways to remove nodes while maintaining the AVL conditions.
        // Please strictly follow the lecture slide method,
        // and if in doubt, please ask TAs using Piazza.
    }
};
